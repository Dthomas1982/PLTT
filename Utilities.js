...
/**********************************************************************
 * Embedded leaderboard display data
 *
 * The main application calculates/writes the authoritative leaderboard
 * sheet first, then reads that sheet back for display.
 **********************************************************************/
